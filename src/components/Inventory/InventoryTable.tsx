        ...
        <div style={{
          ...
          <form
            onSubmit={async e => {
              ...
              const found = inventory.find(item => item.sku === editSku);
              if (found) {
                setEditPart({ ...found });
              }
              setEditStep('form');
          ...
          >
            <input
              ...
              required
              style={{ padding: 8, borderRadius: 6, border: '1px solid #b0c4de' }}
            />
            <input
              type="password"
              placeholder="Password"
          ...
          <tbody>
            {inventory.map((item, idx) => (
              <tr key={idx}>
                ...
                <td style={{ border: '1px solid #b0c4de', padding: 8 }}>{item.sku}</td>
                ...
                <td style={{ border: '1px solid #b0c4de', padding: 8 }}>{item.category}</td>
                <td style={{ border: '1px solid #b0c4de', padding: 8 }}>{item.part}</td>
                <td style={{ border: '1px solid #b0c4de', padding: 8 }}>{item.provider}</td>
                <td style={{ border: '1px solid #b0c4de', padding: 8 }}>{item.brand}</td>
                <td style={{ border: '1px solid #b0c4de', padding: 8 }}>{item.um}</td>
                <td style={{ border: '1px solid #b0c4de', padding: 8 }}>{item.area}</td>
                <td style={{ border: '1px solid #b0c4de', padding: 8 }}>{item.receive ?? ''}</td>
                <td style={{ border: '1px solid #b0c4de', padding: 8 }}>{item.salidasWo ?? ''}</td>
                <td style={{ border: '1px solid #b0c4de', padding: 8 }}>{item.onHand ?? ''}</td>
                <td style={{ border: '1px solid #b0c4de', padding: 8 }}>
                  {item.imagen ? (
                    <a
                ...
                <td style={{ border: '1px solid #b0c4de', padding: 8 }}>{item.precio ?? ''}</td>
              </tr>
            ))}
          </tbody>
        </table>
