...
import WorkOrderPendingPartsPreview from './WorkOrderPendingPartsPreview';
    ...
    <div style={{
      ...
      <div style={{ padding: '16px 20px' }}>
        ...
        {pendingParts && pendingParts.length > 0 && setPendingPartsQty && onAddPendingPart && (
          <WorkOrderPendingPartsPreview
            trailerName={workOrder.trailer}
            pendingParts={pendingParts}
            pendingPartsQty={pendingPartsQty}
            setPendingPartsQty={setPendingPartsQty}
            onAddPendingPart={onAddPendingPart}
          />
        )}
